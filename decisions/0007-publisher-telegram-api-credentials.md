...
## Consequences
Live-TDLib UX drops forced my.telegram.org for every user. Builder wires publisher inject + optional advanced override. If the publisher id is flooded/abused, Telegram can kill it for all official installs — monitor and rotate via new inject.
