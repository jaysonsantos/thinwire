...
v1 protocols are Telegram, WhatsApp (experimental), Discord (bot/OAuth inbox only), and Slack OAuth. Signal is out of v1 release builds. Local feature `signal-local` (#39) is available. It links Presage and libsignal. It stays off by default.
