...
- If TDLib reports "Wrong database encryption key", the app moves the old folder aside to `tdlib.stale-<unix seconds>`. It never deletes that folder. A lock error ("already in use") does not move the folder.
